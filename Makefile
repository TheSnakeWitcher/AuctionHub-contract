...
# contract data
CONTRACT_NAME="AuctionHub"
CONTRACT_SRC="$(SRC)/$(CONTRACT_NAME).sol"
CONTRACT_ADDRESS=""
FORK=

# contract deploy options
MUMBAI_TOKEN_ADDRESS="0xA02f6adc7926efeBBd59Fd43A84f4E0c0c91e832"
# AUCTION_FEE=5%
AUCTION_FEE=5
# AUCTION_PERIOD = 1 weeks
AUCTION_PERIOD=604800 
CONSTRUCTOR_ARGS=$(MUMBAI_TOKEN_ADDRESS) $(AUCTION_FEE) $(AUCTION_PERIOD)
